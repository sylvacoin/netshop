        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?= site_url('products/my-products') ?>" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>My Products</a>
                    </li>
                    <li>
                        <a href="<?= site_url('categories/view') ?>" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Categories</a>
                    </li>
                    <li>
                        <a href="<?= site_url('exlocations/view') ?>" class="waves-effect"><i class="fa fa-font fa-fw" aria-hidden="true"></i>Exchange Locations</a>
                    </li>
                    <li>
